...
// .wrangler/tmp/bundle-3OUUyR/checked-fetch.js
...
var src_default = {
  async fetch(request, env, ctx) {
    ...
    if (url.pathname === "/api/visitor/count" && request.method === "GET") {
      const data = await env.VISITOR_STATS.get(
        "visitor-data",
        "json"
      );
...
// .wrangler/tmp/bundle-3OUUyR/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-3OUUyR/middleware-loader.entry.ts
