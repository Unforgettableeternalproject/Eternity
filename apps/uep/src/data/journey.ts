...
export const PORTAL_ZONE: ZoneData = {
  id: 'portal',
  label: '外部基軸大廳',
  slug: 'portal',
  en: 'Portal',
  kicker: 'Volume VI',
  blurb: '五道光柱指向傳送門，通往各個外部世界。',
  atmos: '金色廳堂、光柱、傳送門',
  icon: 'P',
  glyphs: ['軸', '廳', '門', '界'],
  main: '#D5B618',
...
export const ZONE_NARRATIVES: JourneyNarrative[] = [
  ...
  /* ── 06 外部基軸大廳 ── */
  {
    zoneId: 'portal',
    narration: [
      '這是一座華麗程度不亞於一開始的廳堂，不過是以金色的主題居多。你見到五道光柱正佇立在遠方，指示著類似於傳送門的大型結構。',
      '就在那不到萬分之一秒的瞬間，眼前的少女消失了。而你又再次回到了最一開始的大廳。',
    ],
    uepLines: [
      '噠啷～ 這個地方是所謂的基軸大廳喔! (ﾉ◕ヮ◕)ﾉ*:･ﾟ✧',
      '簡單來說就是一個通往各種不同世界的通道，你會做為一個觀察者去看到各式各樣的事物喔!',
      '這裡應該就是邊際世界裡的最後一個重要地點了，這趟旅程過得還真快啊!',
      '能夠認識你我很開心喔! 我會繼續待在這裡的，而你隨時都可以離開。可以的話希望能夠多多來見我! ヾ(≧ ▽ ≦)ゝ',
      '那麼就先這樣囉!',
    ],
  },
];
