...
export default function UepDialogue({ side = 'left', text, effects = ['shimmer', 'halo'], avatarSize = 52 }: UepDialogueProps) {
  ...
  return (
    <div style={{
      ...
      gap: 14, alignItems: 'flex-start', maxWidth: 640, margin: '14px 0',
    }}>
      <UepAvatar size={avatarSize} halo={effects.includes('halo')} />
      <div style={{
        position: 'relative', flex: 1,
        background: 'linear-gradient(180deg, rgba(213,182,24,0.05), rgba(213,182,24,0.02))',
        ...
        {/* speech tail */}
        <div style={{
          position: 'absolute', top: 18, [isRight ? 'right' : 'left']: -7,
