  ...
  return (
    <div style={{
      ...
      <a href="/" style={{ display: 'flex', alignItems: 'center', gap: 12, textDecoration: 'none', color: 'inherit' }}>
        ...
        <div>
          <div style={{
            ...
            color: 'var(--ink-title)', lineHeight: 1, letterSpacing: '0.01em',
          }}>Imaginary Space</div>
          <div style={{
            fontFamily: 'var(--font-mono)', fontSize: 9.5, color: 'var(--ink-mute)',
            letterSpacing: '0.22em', textTransform: 'uppercase' as const, marginTop: 2,
          }}>邊際世界 · 觀測誌</div>
        </div>
      </a>
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
        {onOpenMap && (
          <button className="btn-outline" onClick={onOpenMap} style={{ padding: '8px 14px' }}>
            ✦ 大地圖
          </button>
        )}
